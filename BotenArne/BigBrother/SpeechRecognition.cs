...
namespace BigBrother
{
    ...
    public class SpeechRecognition
    {
        ...
        public static async Task ContinuousRecognitionWithAuthorizationTokenAsync(ISpeechSender speechSender)
        {

            subscriptionKey = File.ReadAllText(@"c:\code\secrets\boten-arne-azure-key.txt");
